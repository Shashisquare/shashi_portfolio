        ...
        <HeroInnerContainer>
          <HeroLeftContainer id="Left">
            ...
            <SocialMediaIcons>
              <SocialMediaIcon
                title="Email"
                href="mailto:shashipspk2@gmail.com"
                target="display"
              >
                <EmailIcon />
              </SocialMediaIcon>
              ...
              <SocialMediaIcon
                href="https://www.instagram.com/shashisquare/?hl=en"
                target="display"
                title="Instagram"
              >
                <InstagramIcon />
              </SocialMediaIcon>
              <SocialMediaIcon href="https://wa.me/+918142283566" target="display" title="Whatsapp">
                <WhatsAppIcon />
              </SocialMediaIcon>
            </SocialMediaIcons>
            {/* <ResumeButton  onClick={openResumeModal}  >Check Resume</ResumeButton> */}
            <ResumeButton href="https://www.linkedin.com/in/sasi-kumar-alakunta-31aa83217/">
              <span
